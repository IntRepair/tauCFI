...
BPatch_function *ast::function::get_function() const { 
    assert(bp_function);
    return bp_function; }
...
std::string ast::function::get_name_mang() const
{
    return bp_function->getMangledName(); 
}
...
void ast::function::update_basic_blocks(std::vector<basic_block> basic_blocks_)
{
