...
static MachineInstr *FuseTwoAddrInst(MachineFunction &MF, unsigned Opcode,
  ...
  errs() << MF.getName() << " MachineFunction::CreateMachineInstr() X86 - I " << NewMI << '\n';
...
static MachineInstr *FuseInst(MachineFunction &MF, unsigned Opcode,
  ...
  MachineInstr *NewMI =
      MF.CreateMachineInstr(TII.get(Opcode), MI.getDebugLoc(), true);
  errs() << MF.getName() << " MachineFunction::CreateMachineInstr() X86 - II " << NewMI << '\n';
  NewMI->setCallSite(MI.getCallSite());
...
bool X86InstrInfo::unfoldMemoryOperand(
  ...
  errs() << MF.getName() << " MachineFunction::CreateMachineInstr() X86 - III " << DataMI << '\n';
