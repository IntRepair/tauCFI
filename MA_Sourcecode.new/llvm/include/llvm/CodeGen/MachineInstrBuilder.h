...
inline void trace_current_stack()
{
#if 0
  void *array[20];
  size_t size;
...
inline MachineInstrBuilder BuildMI(MachineFunction &MF, const DebugLoc &DL,
  ...
  //errs() << MF.getName() << " MachineFunction::CreateMachineInstr() MIBuilder I " << MI << '\n';
  if (MI->isCall())
    trace_current_stack();
...
inline MachineInstrBuilder BuildMI(MachineFunction &MF, const DebugLoc &DL,
  ...
  MachineInstr *MI = MF.CreateMachineInstr(MCID, DL);
  //errs() << MF.getName() << " MachineFunction::CreateMachineInstr() MIBuilder II " << MI << '\n';
  if (MI->isCall())
    trace_current_stack();
...
inline MachineInstrBuilder BuildMI(MachineBasicBlock &BB,
  ...
  MachineInstr *MI = MF.CreateMachineInstr(MCID, DL);
  //errs() << MF.getName() << " MachineFunction::CreateMachineInstr() MIBuilder III " << MI << '\n';
  if (MI->isCall())
    trace_current_stack();
...
inline MachineInstrBuilder BuildMI(MachineBasicBlock &BB,
  ...
  MachineFunction &MF = *BB.getParent();
  MachineInstr *MI = MF.CreateMachineInstr(MCID, DL);
  //errs() << MF.getName() << " MachineFunction::CreateMachineInstr() MIBuilder IV " << MI << '\n';
  if (MI->isCall())
    trace_current_stack();
...
inline MachineInstrBuilder BuildMI(MachineBasicBlock &BB,
  ...
  MachineFunction &MF = *BB.getParent();
  MachineInstr *MI = MF.CreateMachineInstr(MCID, DL);
  //errs() << MF.getName() << " MachineFunction::CreateMachineInstr() MIBuilder V " << MI << '\n';
  if (MI->isCall())
    trace_current_stack();
...
inline MachineInstrBuilder BuildMI(MachineBasicBlock &BB,
  ...
  MachineFunction &MF = *BB.getParent();
  MachineInstr *MI = MF.CreateMachineInstr(MCID, DL);
  //errs() << MF.getName() << " MachineFunction::CreateMachineInstr() MIBuilder VI " << MI << '\n';
  if (MI->isCall())
    trace_current_stack();
