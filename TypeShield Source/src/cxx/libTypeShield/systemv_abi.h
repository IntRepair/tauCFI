...
default_paramlist()
{
    return std::array<char, 7>{'4', '4', '4', '4', '4', '4', '0'};
}
                   ...
                   register_states_t<liveness::state_t> liveness_state)
{
    ...
    LOG_DEBUG(LOG_FILTER_CALL_SITE, "<CS> Function %s: Instruction %lx provides atmost %d "
...
default_paramlist()
{
    return std::array<char, 7>{'0', '0', '0', '0', '0', '0', '4'};
}
                   ...
                   register_states_t<liveness::state_t> liveness_state)
{
    ...
    LOG_DEBUG(LOG_FILTER_CALL_TARGET, "<CT> Function %s[%lx] requires atleast %d args and "
