...
static bool is_complete_register_saving_block(CADecoder *decoder,
...
static void initialize_variadic_passthrough(AnalysisConfig &config, ast::ast const& ast)
{
...
std::vector<AnalysisConfig> init(CADecoder *decoder, ast::ast const& ast)
{
    ...
    initialize_variadic_passthrough(init_config, ast);
