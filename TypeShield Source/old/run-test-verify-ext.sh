...
python src/py/test_verify_classification_ext.py --analysis-script=$ANALYSIS --binutils-dir=$BINUTILS --llvm-build-dir=$LLVMDIR --source-dir=$SOURCEDIR --test-dir=$TESTDIR
