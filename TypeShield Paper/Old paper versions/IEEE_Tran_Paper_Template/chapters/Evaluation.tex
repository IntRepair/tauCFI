...
\begin{itemize}[leftmargin=.2in]
 \item \textbf{RQ1:} How \textbf{precise} is it? (\cref{section:typeshieldprecision})
 \item \textbf{RQ2:} How \textbf{effective} is it? (\cref{section:typeshieldeffectiveness})
 \item \textbf{RQ3:} What is the \textbf{runtime overhead}? (\cref{section:typeshieldoverheadperformance})
 \item \textbf{RQ4:} What is the \textbf{instrumentation overhead}? (\cref{section:typeshieldoverheadinstrumentation})
 \item \textbf{RQ5:} What \textbf{security level} does it offer? (\cref{RQ5: Security Analysis})
 \item \textbf{RQ6:} Is it superior \textbf{compared} to other tools? (\cref{RQ5: Is TypeShield better than other tools?})
\end{itemize}
...
%     	}
	...
	\textcolor{red}{TODO-add more description in order to indicted the advantage of our tool. What geomean values are good, low or hig? What is the main thing which can be observed if 
...
\resizebox{\columnwidth}{!}{
	...
	{\textit{\csvcolii}  &  \csvcolxii & \csvcolxiii \ (\csvcolxiv \%) & \csvcolxv \ (\csvcolxvi \%) & \csvcoliii & \csvcoliv \ (\csvcolv \%) & \csvcolvi \ (\csvcolvii\%)}% specify your coloumns here
    	\end{tabular}

}
		\caption {The results for analysis using the \textit{count} policy on the O2 optimization level. \textcolor{red}{TODO-add more description in order to indicted the advantage of our tool. What geomean values are good, low or hig? What is the main thing which can be observed if 
	looking at this table?}}
...
\resizebox{\columnwidth}{!}{
	...
	\caption {The results for analysis using the \textit{type} policy on the O2 optimization level. \textcolor{red}{TODO-add more description in order to indicted the advantage of our tool. What geomean values are good, low or hig? What is the main thing which can be observed if 
	looking at this table?}}
...
\begin{center}
 \resizebox{2\columnwidth}{!}{
	...
	for optimization level O2. \textcolor{red}{TODO-add more description in order to indicted the advantage of our tool. What geomean values are good, low or hig? What is the main thing which can be observed if 
	looking at this table?}}
...
\begin{figure}[!h]
    ...
    \textcolor{red}{TODO-add more description in order to indicted the advantage of our tool. What geomean values are good, low or hig? replace with our values. remove this stub.}}
...
%     	}
	...
	\textsc{TypeShield} currently does not include function return types as TypeArmor does. 
	\textcolor{red}{TODO-add more description in order to indicted the advantage of our tool. What geomean values are good, 
	low or hig? What is the main thing which can be observed if 
	looking at this table?}}
