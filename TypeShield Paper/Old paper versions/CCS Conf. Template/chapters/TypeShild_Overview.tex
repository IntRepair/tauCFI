...
to all legitimate calltargets return addresses (i.e., function return address). 
...
In case a CFI policy schema is on function parameter count with callsite overestimation and calltarget subestimation 
...
Such a parameter count based policy is not precise and would allow any call transfer 
...
In order to effectively deal with this limitation we extend the above presented parameter count based policy in order to
