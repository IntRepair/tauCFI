...
\caption{The \emph{type} policy schema for callsites and calltargets. Note that p. means parameter. As it is depicted in this example, when requiring width, one starts at the 
bottom and grows to the top, as it is always possible to accept more parameters than required.
The reverse is true for providing, as it is possible to accept less parameters than provided.}
