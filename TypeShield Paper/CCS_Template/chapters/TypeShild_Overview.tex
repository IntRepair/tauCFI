...
control flow and that an efficient solution for backward CFI is in place.
...
Figure~\ref{Type and parameter count policy.} depicts~\footnote{The $X$ and $Y$ axis of matrices $M1, M2$ and $M3$ represent function parameter count 
...
Figure~\ref{fig:lattice3264} represents~\footnote{$a$ $\wedge$ $b$ $\in \{0-bit, 8-bit, 16-bit, 32-bit, 64-bit\}$ and the two 
