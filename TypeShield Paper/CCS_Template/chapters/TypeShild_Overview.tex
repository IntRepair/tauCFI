...
invariants for calltargets and callsites in~\cref{Invariants for Targets and Callsites}, and 
in~\cref{TypeShield Policy Mechanism} we present our function parameter type aware policy and give a formal description of it
by relating it to~\cite{veen:typearmor}. Finally, in~\cref{TypeShild Impact on COOP} we highlight the impact of our policy on COOP.
