...
%     	}
	...
	We can see that our type-based tool on average reduces the number of calltargets by 37\% when 
	compared to AT method and by 13\% when comparing with TypeArmor.
}
