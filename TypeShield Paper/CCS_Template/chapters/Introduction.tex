...
In this paper, we present \textsc{TypeShield}, a runtime binary-level fine-grained CFI tool for illegitimate forward calls, 
...
forward calls in detail, 
 ...
 \item 
% $\bullet$ 
\textbf{Illegitimate indirect calls detection tool.} We designed and implemented an illegitimate indirect calls detection tool based on a novel 
 function parameter count and type technique. \textsc{TypeShield} is a general, automated, and easy-to-deploy 
 ...
 evaluation results are available at \url{https://github.com/domain/typeshield}.
...
\textbf{Evaluation and analysis.} We conduct a thorough set of evaluative experiments. In particular, we demonstrate experimentally that our precise binary-level 
 ...
 Our evaluation shows that \textsc{TypeShield} imposes up to 4\% overhead for performance-intensive benchmarks such as the SPEC CPU2006 benchmarks.
 ...
 providing for each conducted experiment a precise description of the experiment setup, and comprehensive results, including mean, median, geomean values
