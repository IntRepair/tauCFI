...
X axis is years (left \& right) and Y axis is number of reports in logarithmic scale (left, 143) and distribution in \% of the reports (right, 701).
As of May'17, U.S. NVD reports in total 701 ACEs from which 143 are the result of a vptr/vtable corruption (see * above) that are exploited by highjacking forward indirect calls.
