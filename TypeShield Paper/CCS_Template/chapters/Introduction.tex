...
\begin{itemize}[leftmargin=.12in]
 ...
 \item \textbf{Novel Forward Edge Based Attacks Mitigation Technique.} We designed a novel illegitimate indirect calls detection technique based on function parameter 
 ...
 \item \textbf{Implemented Prototype.} We implemented, \textsc{TypeShield}, a prototype which enforces the aforementioned technique.
 ...
 \item \textbf{Usable Prototype and Reproducibility of Results.} The source code, test scripts and 
