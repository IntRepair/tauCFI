...
Further our evaluation results indicate that \textsc{TypeShield} can considerably reduce the forward-edge legal 
call target set while providing high precision and low overhead w.r.t. the backward-edge policy.
