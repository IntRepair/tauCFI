...
%  \item[
 \textbf{RQ1:} How \textbf{precise} is \textsc{TypeShield}? (\cref{section:typeshieldprecision})\vspace{-.2cm}

%  \item[
 \textbf{RQ2:} How \textbf{effective} is \textsc{TypeShield}? (\cref{section:typeshieldeffectiveness})\vspace{-.2cm}

%  \item[
 \textbf{RQ3:} What \textbf{overhead} imposes \textsc{TypeShield}? (\cref{section:typeshieldoverheadperformance})\vspace{-.2cm}

%  \item[
 \textbf{RQ4:} What \textbf{binary blow-up} has \textsc{TypeShield}? (\cref{section:typeshieldoverheadinstrumentation})\vspace{-.2cm}

%  \item[
 \textbf{RQ5:} What \textbf{security level} offers \textsc{TypeShield}? (\cref{RQ5: Security Analysis})\vspace{-.2cm}

%  \item[
 \textbf{RQ6:} Which \textbf{upper bounds} has \textsc{TypeShield}? (\cref{RQ6:TyperArmor's Imprecise Parameter-Count Policy})\vspace{-.2cm}
  
  \textbf{RQ7:} Which \textbf{attacks} mitigates \textsc{TypeShield}? (\cref{RQ7: Mitigation of Advanced Code-Reuse Attacks})\vspace{-.2cm}
  
 \textbf{RQ8:} Is \textsc{TypeShield} \textbf{effective} against COOP? (\cref{RQ8: Effectiveness Against COOP})\vspace{-.2cm}
  
 %  \item[
 \textbf{RQ9:} Are other tools \textbf{better} than \textsc{TypeShield}? (\cref{RQ9: Is TypeShield better than other tools?})\vspace{-.2cm}

 
 %  \item[
 \textbf{RQ10:} Is shadow-stack \textbf{better} than \textsc{TypeShield}? (\cref{RQ10: Comparison with SafeStack})\vspace{-.2cm}
...
\subsection{TyperShield Upper Bounds (RQ6)}
...
\subsection{Mitigation of Advanced Code-Reuse Attacks (RQ7)}
...
\end{tabular}
\begin{tablenotes}
  \item[a] Jump to an address that is $\notin$ in the $max - min$ address range.
  \item[b] Jump to an address which is $\ne$ to one of the legitimate addresses.
  \item[c] Jump to an address label that is $\ne$ with the calltarget return label.
  \end{tablenotes}
  \end{threeparttable}
\caption{Stopped attacks.}
...
\subsection{Effectiveness Against COOP (RQ8)}
...
\subsection{Forward-Edge Comparison with Other Tools (RQ9)}
...
\subsection{Backward-edge Comparison with Shadow-Stack (RQ10)}
