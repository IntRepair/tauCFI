...
by deploying only the forward-edge or the backward-edge policy. In Table~\ref{Stopped attacks.} the FP label means forward-edge 
policy while BP means backward-edge policy.
