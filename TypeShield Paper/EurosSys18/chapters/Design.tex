...
binary is based on DynInst~\cite{bernat:dyninst} capabilities. DynInst is a binary rewriting framework which allows 
to instrument binaries during loading or runtime and can be used to
build: 
(1) performance measurement tools,
(2) correctness debuggers (\textit{i.e.,} efficient data breakpoints),
(3) execution drive simulations, and 
...
We built a function parameter count-based policy
