...
% and~\cite{NVD:ACE}) 
demonstrates the security shortcomings and the need to address this problem space.
...
% [leftmargin=.35cm]
 ...
 \item We designed a novel fine-grained CFI technique for protecting forward and backward edges in a CFG
 against code reuse attacks.
 
 \item We implemented, \textsc{TypeShield}, a prototype which enforces the aforementioned technique
 ...
 \item We conduct a thorough set of evaluative experiments in which we show that \textsc{TypeShield} is more precise and effective than 
 ...
 \item We respond to calls emphasizing the importance of reproducibility of evaluation results (see NISTIR 7564~\cite{reprod:nist} and the security and measurements 
