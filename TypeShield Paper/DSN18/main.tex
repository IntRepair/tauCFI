...
We propose \textsc{TypeShield}, a binary runtime forward-edge and backward-edge protection tool instrumenting program executables at load time. \textsc{TypeShield} enforces a novel runtime
