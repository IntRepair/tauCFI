...
\begin{figure}[H]
  \begin{tikzpicture}
    \begin{axis}[
        ...
        xlabel={},
        symbolic x coords={namd,dealII,soplex,mcf,povray,hmmer,sjeng,libquantum, h264ref, omnetpp, astar, xalancbmk, average, geomean},
        xtick=data,
        width=9cm,
        height=6.5cm,
      ...
      \addplot[darkgray, fill=darkgray] coordinates {
        (namd, 0.29) (dealII, 0.44) (soplex, 0.29) (mcf, 0.41) (povray, 0.43) (hmmer, 0.39) (sjeng, 0.46) (libquantum, 0.43) (h264ref, 0.53) (omnetpp, 0.59) (astar, 0.62) (xalancbmk, 0.44) (average, 0.44) (geomean, 0.43)
      };
      \addplot[black, fill=black] coordinates {
        (namd, 0.40) (dealII, 0.66) (soplex, 0.41) (mcf, 0.56) (povray, 0.48) (hmmer, 0.39) (sjeng, 0.47) (libquantum, 0.38) (h264ref, 0.51) (omnetpp, 0.42) (astar, 0.45) (xalancbmk, 0.34) (average, 0.45) (geomean, 0.45)
      };
      \legend{Vanila Benchmark, \textsc{TypeShield}}
    \end{axis}
  \end{tikzpicture}
  \caption{SPEC CPU2006 runtime with no instrumentation (shaded gray), and with instrumentation (shaded black).}
