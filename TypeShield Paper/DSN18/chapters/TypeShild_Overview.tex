...
% while in~\cref{TypeShield Policy Mechanism} we present our type based policy and approach overview.
...
% \textsc{TypeShield} provides three modes of operation for
