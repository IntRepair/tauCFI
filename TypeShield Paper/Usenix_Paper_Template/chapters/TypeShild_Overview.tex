...
\begin{tikzpicture}
\draw[thick] (0,-3) [blue] rectangle node[anchor=center]  (0)  {\LARGE{$\bot$ (0, 0)}}   (2,-4);
\draw[thick] (0,0) rectangle node[anchor=center]  (320)  {\LARGE{(a, 0)}}  (2,-1);
\draw[thick] (3,2) rectangle node[anchor=center]  (640)  {\LARGE{(b, 0)}}  (5,1);
\draw[thick] (0,3) rectangle node[anchor=center]  (3232) {\LARGE{(a, a)}} (2,4);
\draw[thick] (3,5) rectangle node[anchor=center]  (6432) {\LARGE{(b, a)}} (5,6);
\draw[thick] (-1,5) rectangle node[anchor=center] (3264) {\LARGE{(a, b)}} (-3,6);
\draw[thick] (0,7) [blue] rectangle node[anchor=center]  (6464) {\LARGE{$\top$ (b,b)}} (2, 8);
