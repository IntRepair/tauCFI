...
This represents a fine-grained alternative to SafeStack which was
bypassed~\cite{safestack:bypassing}.

\textbf{\textit{Comparison.}}~\textsc{TypeShield} uses partially different basic block analysis strategies than TypeArmor,
...
\begin{itemize}
 ...
 thus increasing the reproducibility of our results.
