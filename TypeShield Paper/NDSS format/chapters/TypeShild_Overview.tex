...
\centering
   \includegraphics[width=.88\textwidth]{figures/overview.pdf}
    \caption{System overview. The program binary is analyzed by \textsc{TypeShield} and the calltargets and callsite analysis are performed for determining how many parameters are 
    provided, how many are consumed and thyr register wideness.
    After this step labels are inserted at each previously identified callsite and at each calltargets. 
