...
% \resizebox{\columnwidth}{!}{%
 \begin{tabular}{ l  c  p{2.5cm}  } 
  ...
  All Backward 
  edge \\ violating 
  attacks            & \checkmark (BP)  & (1) Jump to address that is not contained in the $max - min$ address range (2) jump to address $\ne$ legitimate addresses located after each legitimate
  callsite\\
