...
Finally, as TypeArmor is too permissive (see also Figure H.1~\cite{vci:asiaccs} for more details) we present \textsc{TypeShield} which 
can deal with the aforementioned 4 types of register widths can further help to reduce the the allowed
