...
%drawing numbers inside circles
\usepackage{tikz}

%multi rows in a table column
\usepackage{multirow}
...
%used for dot after numbers in listings
\makeatletter
...
%disable copytight text on the left corner of the first page
\makeatletter
