...
#define LOG_LEVEL_FILE_CONFIG                                                                      \
    (LOG_LEVEL_FATAL | LOG_LEVEL_ERROR | LOG_LEVEL_WARNING | LOG_LEVEL_INFO | LOG_LEVEL_DEBUG |    \
     LOG_LEVEL_TRACE)
...
#define LOG_FILTER_CONFIG                                                                          \
    (LOG_FILTER_GENERAL | LOG_FILTER_TAKEN_ADDRESS | LOG_FILTER_CALL_TARGET | LOG_FILTER_CALL_SITE)
#define LOG_FILTER_FILE_CONFIG                                                                     \
    (LOG_FILTER_GENERAL | LOG_FILTER_CALL_TARGET | LOG_FILTER_CALL_SITE |                          \
     LOG_FILTER_INSTRUMENTATION | LOG_FILTER_REACHING_ANALYSIS | LOG_FILTER_LIVENESS_ANALYSIS)
