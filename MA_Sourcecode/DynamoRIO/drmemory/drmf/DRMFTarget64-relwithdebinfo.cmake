...
set_target_properties(drsyscall PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmemory/drmf/lib64/release/libdrsyscall.so.1.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrsyscall.so.1.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsyscall )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsyscall "${_IMPORT_PREFIX}/drmemory/drmf/lib64/release/libdrsyscall.so.1.0" )
...
set_target_properties(drsymcache PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmemory/drmf/lib64/release/libdrsymcache.so.1.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrsymcache.so.1.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsymcache )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsymcache "${_IMPORT_PREFIX}/drmemory/drmf/lib64/release/libdrsymcache.so.1.0" )
...
set_target_properties(umbra PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELWITHDEBINFO "dynamorio;drmgr;drcontainers"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmemory/drmf/lib64/release/libumbra.so.1.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libumbra.so.1.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS umbra )
list(APPEND _IMPORT_CHECK_FILES_FOR_umbra "${_IMPORT_PREFIX}/drmemory/drmf/lib64/release/libumbra.so.1.0" )
...
set_target_properties(drfuzz PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmemory/drmf/lib64/release/libdrfuzz.so.1.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrfuzz.so.1.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS drfuzz )
list(APPEND _IMPORT_CHECK_FILES_FOR_drfuzz "${_IMPORT_PREFIX}/drmemory/drmf/lib64/release/libdrfuzz.so.1.0" )
