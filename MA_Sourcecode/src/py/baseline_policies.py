...
def compare_all(fldr_path, prg_name):
    ...
    count_compare_safe = generate_count_compare_prec(clang, fldr_path, prg_name, __all_functions_at)
    count_compare_safe["target"] = prg_name
    count_compare_safe["policy"] = "COUNT_SAFE"
    ...
    type_compare_safe = generate_type_compare_prec(clang, fldr_path, prg_name, __all_functions_at)
    type_compare_safe["target"] = prg_name
    type_compare_safe["policy"] = "TYPE_SAFE"
...
def compare_our_at_all(fldr_path, prg_name):
    ...
    #count_compare_safe["target"] = prg_name
    count_compare_safe = generate_count_compare_prec(clang, fldr_path, prg_name, __ours_functions_at)
    count_compare_safe["target"] = prg_name
    count_compare_safe["policy"] = "COUNT_SAFE"
    ...
    #type_compare_safe["target"] = prg_name
    type_compare_safe = generate_type_compare_prec(clang, fldr_path, prg_name, __ours_functions_at)
    type_compare_safe["target"] = prg_name
    type_compare_safe["policy"] = "TYPE_SAFE"
