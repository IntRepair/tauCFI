...
{
    AnalysisConfig(ast::ast const &ast_) : ast(ast_), ignore_instructions(), block_states() {}

    std::shared_ptr<AddressSet> ignore_instructions;
    std::shared_ptr<AddressSet> quasi_empty_return_blocks;
