...
In our evaluation we addressed the following research targets:
\begin{itemize}
<<<<<<< HEAD
 \item \textbf{RQ1:}How precise is \textsc{TypeShield}? (\cref{section:typeshieldprecision})

 \item \textbf{RQ2:}What is the effectiveness of \textsc{TypeShield}? (\cref{section:typeshieldeffectiveness})

 \item \textbf{RQ3:}What runtime overhead has \textsc{TypeShield}? (\cref{section:typeshieldoverheadperformance})
...
=======
 ...
 \item[\textbf{RQ3}] Runtime overhead of \textsc{TypeShield} (\cref{section:typeshieldoverheadperformance})
 \item[\textbf{RQ4}] Instrumentation overhead of \textsc{TypeShield}(\cref{section:typeshieldoverheadinstrumentation})
 \item[\textbf{RQ5}] Comparison to other tools(\cref{RQ5: Is TypeShield better than other tools?})
>>>>>>> 9e9898d1e7936aa1af2242b7a5440e88e111c822
\end{itemize}
...
Figures, \ref{fig7}, \ref{fig8}, \ref{fig9}, and \ref{fig10} depict the CDFs for the following programs: node.js, proftpd, mysql, and postgresql.
...
executable section. Moreover this is also dependent on the actual structure of the target, as it 
depends on the number of indirect control flow operations per time unit.
=======
