...
\begin{center}
 \resizebox{2\columnwidth}{!}{
	...
	for optimization level O2. \textcolor{red}{TODO-add more description in order to indicted the advantage of our tool. What is the main thing which can be observed if 
