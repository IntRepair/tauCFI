...
When looking at the CDFs of legal callsite targets as shown for 
postgresql \ref{fig7}, node.js \ref{fig8}, proftpd \ref{fig9}, mysql \ref{fig10}, 
one should instantly see the difference between the type and the count policies. 
...
before. However, all of that is also dependent on the structure of the program.
