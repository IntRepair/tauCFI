...
To implement the \emph{type} policy, we need a finer representation:
\begin{enumerate}
\item W represents write before read access
\item r8, r16, r32, r64 represents read before write access with 8, 16, 32, 64 bits wideness
\item C represents the absence of access
\end{enumerate}
Furthermore we allow our merge operations to also return the value RW, which represents the existence of both read and write access.
%\begin{enumerate}
